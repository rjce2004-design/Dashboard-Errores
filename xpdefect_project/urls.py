...
urlpatterns = [
    ...
    path('bug/<int:bug_id>/retroceder/', retroceder_estado, name='retroceder_estado'),
    path('hu/<int:hu_id>/eliminar/', eliminar_hu, name='eliminar_hu'),
    path('equipo/<int:equipo_id>/eliminar/', eliminar_equipo, name='eliminar_equipo'),
